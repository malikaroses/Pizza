<template>
	<div class="content">
		<div class="container container--cart">
			<div v-if="addedPizzas.length" class="cart">
				<div class="cart__top">
...
export default {
	...
	setup() {
		...
		const totalSum = computed(() => store.getters.getAddedPizzsaSum);

		const addedPizzas = computed(() => store.getters.getCartItemPizzas);

		const clearCart = () => {
			store.commit("CLEAR_CART");
		};

		return { addedPizzas, clearCart,totalCount,totalSum };
	},
};
</script>
