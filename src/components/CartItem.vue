<template>
	<div v-if="pizza" class="cart__item">
  ...
  props: ['pizza'],
	setup(props) {
		...
		const handleDeletePizza = () => {
			store.commit('DELETE_CART_ITEM', props.pizza)
		}
		...
		return {pizzaTotalPrice,handleDeletePizza,handleDecrementPizza,handleIncrementPizza};
	},
};
</script>
